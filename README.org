...
| <v>    | Typed motion range of visual range (BEG END TYPE). If visual state is inactive then those values are nil                                                                                                                                                                                                                                                         |                                                                                         |
| <x>    | Current register                                                                                                                                                                                                                                                                                                                                                 |                                                                                         |
...
| <xc/>  | Ex register and count argument, both optional. Can be used for commands such as :delete [REGISTER] [COUNT] where the command can be called with either zero, one or two arguments                                                                                                                                                                                | When the argument is one, if it's numeric it's treated as a COUNT, otherwise - REGISTER |
